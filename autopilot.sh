#!/bin/bash
# Autopilot: espera a que el WAN acabe, copia a Pi y arranca el siguiente personaje
# Uso: bash autopilot.sh  (lanzar con nohup en background)
set -e
...
# Esperar a que Ada acabe (ya está corriendo por separado)
